  ...
  <body>
    ...
    <body>
      <div class="jumbotron text-center">
        ...
        <p class="lead"><strong>Please check your email</strong> you have successfully applied for the job. </p>
        <hr>
        <p>
          Having trouble? <a style="color: #9d00ff;" href="contact">Contact us</a>
        </p>
        <p class="lead">
          <a class="btn btn-primary btn-sm" href="User" role="button">Continue to Homepage</a>
        </p>
      </div>
    </body>
  </body>
